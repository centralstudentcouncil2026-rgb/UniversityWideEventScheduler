try {
  await import('./portal-guard.js?v=20260622-account-identity-v1');
} catch (error) {
...
if (window.CONNECT_AUTHENTICATED_USER) {
  ...
  await import('./script.js?v=20260622-account-identity-v1');
  await import('./portal-wiring.js?v=20260622-account-identity-v1');
} else {
  window.location.replace('index.html');
}
